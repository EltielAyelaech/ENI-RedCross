...
public class TestAssoAddress {
	...
	public static void main(String[] args) {
		...
		GeneralistDoctor edmond = new GeneralistDoctor("Bosapin", "Edmond", "+33 2 17 18 19 20", nio);
		GeneralistDoctor djemila = new GeneralistDoctor("Table", "Djémila", "03-04-05-06-07", sh);
