...
public class TestExpectedP7 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MedicalFileHandler.add(new MedicalFile(54, 172, "15/7", 95, 135, "probleme d'arythmie cardiaque", "Xarelto 20 mg (le soir au diner) - Bisoprolol 2.5mg (le matin au déjeuner)", LocalDate.of(2023, 3, 5), (Patient)jean, celine));
			MedicalFileHandler.add(new MedicalFile(77, 170, "15/7", 94, 70, "probleme d'hypertension", "Perindropil 2mg (le matin au petit déjeuner)", LocalDate.of(2023, 3, 15), (Patient)adhemar, edmond));
